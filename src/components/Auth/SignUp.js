    ...
    switch (name) {
      case "username":
        ...
        user.username.length < 6
          ? setstateFormErr({
              ...stateFormErr,
              userNameErr: "User name be at least 6 characters",
            })
          : setstateFormErr({ ...stateFormErr, userNameErr: "" });
        break;
      case "dob":
      ...
      case "email":
        ...
        !emailRegEx.test(user.email)
          ? setstateFormErr({ ...stateFormErr, emailErr: "Invalid email!" })
          : setstateFormErr({ ...stateFormErr, emailErr: "" });
        break;
      case "password":
        ...
        user.password.length < 6
          ? setstateFormErr({
              ...stateFormErr,
              passwordErr: "Password be at least 6 characters",
            })
          : setstateFormErr({ ...stateFormErr, passwordErr: "" });
        if (stateForm.rePass)
          stateForm.rePass != user.password
            ? setstateFormErr({
                ...stateFormErr,
                rePassErr: "Passwords do not match!",
              })
            : setstateFormErr({ ...stateFormErr, rePassErr: "" });
        break;
      case "confirm_password":
        setstateForm({ ...stateForm, rePass: user.confirm_password });
        stateForm.password != user.confirm_password
          ? setstateFormErr({
              ...stateFormErr,
              rePassErr: "Passwords do not match!",
            })
        ...
        <form>
          ...
          <div className="form-group">
            <div className="input-group">
              ...
              >
                <small className="text-danger">{stateFormErr.rePassErr}</small>
              </div>
              <div className="input-group-prepend">
                <span className="input-group-text">
                  <i className="fa fa-lock" />
